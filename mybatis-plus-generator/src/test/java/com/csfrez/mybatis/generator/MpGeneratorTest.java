package com.csfrez.mybatis.generator;
...
public class MpGeneratorTest {
    ...
    public void generateCode() {
        generate("image", new String[]{"eis_oss_config", "eis_file_format"});
    }
...
//        String projectPath = System.getProperty("user.dir");
        gc.setOutputDir("D:\\Github\\mybatis");
        gc.setAuthor("Frez");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://47.106.93.140:3306/eis_image?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=GMT%2B8");
        ...
        pc.setParent("com.csfrez.mybatis.generator");
